...
- html, 모바일버전 css 파일 하나로 정리 == index-m.css
- 미디어쿼리 작업 시 파일명 : index-pc_$.css ($ == 본인 이름 대문자명)
...
#### 해결 방법
- [x] 1. 누락된 외부 링크 찾아 다시 연결.
- [x] 2. variable.css 사용해서 폰트 연결 및 코드 정리
- [x] 3. 넘치는 이유 찾아서 수정 진행
